...
% ── SLIDE 1: PORTADA (réplica exacta del PPT) ──
{
\setbeamertemplate{footline}{}
...
\begin{frame}[plain]
    ...
    \begin{center}
        {\fontsize{30}{36}\selectfont\bfseries\color{white}%
            CLASIFICACIÓN DE DAÑO EN AISLADORES\\[4pt]
            SÍSMICOS MEDIANTE MACHINE LEARNING\\[4pt]
            Y DEEP LEARNING\par}

        \vspace{0.5cm}

        % Subtítulo
        {\fontsize{18}{22}\selectfont\color{subtitleblue}%
            Un Análisis Comparativo con Señales de Vibración Ambiental\par}

        \vfill

        % Información institucional
        {\fontsize{15}{20}\selectfont\color{infoblue}%
            Tesis de Maestría en Data Science e Inteligencia Artificial\par}

        \vspace{0.3cm}

        {\fontsize{13}{18}\selectfont\color{subtitleblue}%
            Universidad de Ingeniería y Tecnología --- UTEC\par}

        \vspace{0.3cm}

        {\fontsize{13}{18}\selectfont\color{fadeblue}%
            2026\par}
...
% ── SLIDE 16: CIERRE (réplica exacta del PPT) ──
{
\setbeamertemplate{footline}{}
\setbeamercolor{background canvas}{bg=mainblue}
\begin{frame}[plain]
    ...
    \begin{center}
        {\fontsize{40}{48}\selectfont\bfseries\color{white} ¡Gracias!\par}
        ...
        {\fontsize{20}{24}\selectfont\color{infoblue}%
            ¿Preguntas?\par}
    \end{center}
\end{frame}
}
