...
\setbeamertemplate{footline}{%
    ...
    \hbox{%
        ...
        \end{beamercolorbox}%
        \begin{beamercolorbox}[wd=.3\paperwidth, ht=2.5ex, dp=1.5ex, rightskip=0.5cm, right]{fg=lightgray}%
            {\color{lightgray}\scriptsize\insertframenumber/\inserttotalframenumber}%
        \end{beamercolorbox}%
    }%
    \vskip4pt%
}
