...
\setbeamertemplate{footline}{%
    \begin{tikzpicture}[remember picture, overlay]
        \node[anchor=south west, font=\scriptsize, text=lightgray]
            at ([xshift=0.5cm, yshift=0.3cm] current page.south west)
            {Clasificación de Daño en Aisladores Sísmicos --- Tesis de Maestría};
        \node[anchor=south east, font=\scriptsize, text=lightgray]
...
\begin{frame}{Pre procesamiento}
    \centering
    \includegraphics[width=0.87\textwidth]{cap3_medicion_sync.png}\\[-0.3em]
    {\color{lightgray}\tiny Fuente: Elaboración propia}
\end{frame}
...
\begin{frame}{Interpretabilidad: Eigen-CAM}
    ...
    \vfill
    \centering
    \includegraphics[width=0.85\textwidth]{cap4_eigencam_frecuencias.png}\\[-0.3em]
    {\color{lightgray}\tiny Fuente: Elaboración propia}
\end{frame}
