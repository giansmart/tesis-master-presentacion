...
\setbeamertemplate{footline}{%
    \leavevmode%
    \hbox{%
        \begin{beamercolorbox}[wd=.7\paperwidth, ht=2.5ex, dp=1ex, left]{fg=lightgray}%
            \hspace{0.5cm}{\color{lightgray}\scriptsize Clasificación de Daño en Aisladores Sísmicos --- Tesis de Maestría}%
        \end{beamercolorbox}%
        \begin{beamercolorbox}[wd=.3\paperwidth, ht=2.5ex, dp=1ex, right]{fg=lightgray}%
...
% Reducir padding superior del frametitle
