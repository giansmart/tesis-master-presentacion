...
\begin{frame}{Pre procesamiento}
    \centering
    \includegraphics[width=0.88\textwidth]{cap3_medicion_sync.png}\\
    {\color{lightgray}\tiny Fuente: Elaboración propia}
\end{frame}
...
\begin{frame}{Sensibilidad Clínica: ¿Cuánto daño detectamos?}
    \begin{columns}[c]
        ...
        \end{column}
        \begin{column}{0.50\textwidth}
            \includegraphics[width=0.88\textwidth]{cap4_cm_fft_pca_rf_fold_global_isolator.png}\\
            {\color{lightgray}\tiny Fuente: Elaboración propia}
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}{Interpretabilidad: Eigen-CAM}
    ...
    \vfill
    \centering
    \includegraphics[width=0.85\textwidth]{cap4_eigencam_frecuencias.png}\\
    {\color{lightgray}\tiny Fuente: Elaboración propia}
\end{frame}
...
\begin{frame}{Perfil Multidimensional de los Pipelines}
    \begin{columns}[c]
        \begin{column}{0.62\textwidth}
            \centering
            \includegraphics[height=0.75\textheight]{cap4_radar_pipelines_cropped.png}\\
            {\color{lightgray}\tiny Fuente: Elaboración propia}
        \end{column}
        \begin{column}{0.35\textwidth}
            \footnotesize
